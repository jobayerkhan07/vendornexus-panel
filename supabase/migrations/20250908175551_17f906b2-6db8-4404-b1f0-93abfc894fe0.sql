-- Balance Management System Tables and Functions
...
CREATE TABLE public.user_balances (
  ...
  available_balance DECIMAL(12,2) GENERATED ALWAYS AS (current_balance + credit_limit) STORED,
...
-- Create credit allocations table for tracking credit given by resellers/admins
...
CREATE INDEX idx_credit_allocations_from_user ON public.credit_allocations(from_user_id);
CREATE INDEX idx_credit_allocations_to_user ON public.credit_allocations(to_user_id);
